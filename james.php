    ...
    <div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="layouts.html"><i class="fa fa-th-large"></i> <span class="nav-label">Listing</span></a>
                </li>
                <li>
                    <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">Marketing</span></a>
                </li>
                <li>
                    <a href="metrics.html"><i class="fa fa-tools"></i> <span class="nav-label">Tools</span>  </a>
                </li>
                <li>
                    <a href="widgets.html"><i class="fa fa-flask"></i> <span class="nav-label">Transcations</span></a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Contacts</span></a>
                </li>
